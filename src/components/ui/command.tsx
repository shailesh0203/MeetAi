...
function CommandResponsiveDialog({
  ...
  <Drawer {...props}>
    <DrawerContent className="overflow-hidden p-0">
      ...
      <Command shouldFilter={shouldFilter} className="[&_cmdk-group-heading]:text-muted-foreground [&_cmdk-group-heading]:px-2 [&_cmdk-group]:px-2 [&_cmdk-group]:not([hidden])~[cmdk-group]:pt-0 [&_cmdk-input-wrapper_svg]:h-5 [&_cmdk-input-wrapper_svg]:w-5 [&_cmdk-input-wrapper]:h-12 [&_cmdk-item]:px-2 [&_cmdk-item]:py-3 [&_cmdk-item_svg]:h-5 [&_cmdk-item_svg]:w-5">
        {children}
      </Command>
    </DrawerContent>
  </Drawer>
